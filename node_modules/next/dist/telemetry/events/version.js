...
if(typeof "9.3.2-canary.0"!=='string'){return[];}const userConfiguration=getNextConfig(phase,dir);const payload={nextVersion:"9.3.2-canary.0",nodeVersion:process.version,cliCommand:event.cliCommand,isSrcDir:event.isSrcDir,hasNowJson:event.hasNowJson,isCustomServer:event.isCustomServer,hasNextConfig:!!userConfiguration,buildTarget:(_ref=userConfiguration===null||userConfiguration===void 0?void 0:userConfiguration.target)!==null&&_ref!==void 0?_ref:'default',hasWebpackConfig:typeof(userConfiguration===null||userConfiguration===void 0?void 0:userConfiguration.webpack)==='function',hasBabelConfig:hasBabelConfig(dir)};return[{eventName:EVENT_VERSION,payload}];}